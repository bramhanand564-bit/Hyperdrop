...
- 2026-09-19: Completed V0.1 end-to-end runtime wiring and acceptance suite. V0.1 is marked COMPLETE; V0.2 foundation started with SQLite memory, ranked retrieval, durable JobWorker, ToolCall/ToolOutcome contracts, JSONL audit logging, and Android Gradle project shell. Runtime can select JSON or SQLite memory backend. Added focused tests for the new components.
