...
- 2026-09-19: Completed V0.1 end-to-end runtime wiring and acceptance suite. V0.1 is marked COMPLETE; V0.2 foundation expanded with ranked recall policy, cooperative JobScheduler, scoped sensitive-action confirmation policy, Android task-control layer, browser/computer-use contracts with dry-run adapter, and versioned resume state. Runtime can select JSON or SQLite memory backend.
