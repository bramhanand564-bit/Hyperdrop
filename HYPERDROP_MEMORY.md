...
- 2026-09-19: Completed V0.1 end-to-end runtime wiring and acceptance suite. V0.1 is marked COMPLETE; V0.2 foundation expanded with ranked recall policy, cooperative JobScheduler, scoped sensitive-action confirmation policy, and Android task-control layer. Runtime can select JSON or SQLite memory backend. Added focused tests for retrieval policy, scheduler, and permissions.
