...
export default function AttachmentMenu({isVisible,onImage,onVideo,onDocument,onVoice,onLocation,onContact}){
 ...
 const items=[['image','Gallery',onImage,'#4D8DFF'],['videocam','Video',onVideo,'#6C7EEA'],['document','File',onDocument,'#087EFF'],['mic','Voice',onVoice,'#35C76F'],['location','Place',onLocation,'#5A91B8'],['person','Person',onContact,'#6D8FD6']];
